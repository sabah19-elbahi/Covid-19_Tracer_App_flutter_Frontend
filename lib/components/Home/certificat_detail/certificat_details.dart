...
class CertificatDetails extends StatefulWidget {
  QrCodeModel qr_code;
  Function setDataList;

  CertificatDetails(this.qr_code, this.setDataList);

  @override
  _CertificatDetailsState createState() => _CertificatDetailsState();
}

class _CertificatDetailsState extends State<CertificatDetails> {
  String dropdownValue = 'dropdown_Certificate'.tr;
      ...
      body: SingleChildScrollView(
        child: Column(
            ...
            children: <Widget>[
              ...
              TitleWithCustomUnderline2(text: 'subtitle14_validatecert'.tr),
