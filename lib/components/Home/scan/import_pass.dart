...
import 'package:covid_app2/components/Home/certificat_detail/passva_detail.dart';
...
class ImportPass extends StatefulWidget {
  ...
  ImportPass(this.setDataList);

  @override
  _ImportPassState createState() => _ImportPassState();
}
            ...
            onTap: () async {
              ...
              if (result != null) {
                ...
                Navigator.of(context).pushReplacement(MaterialPageRoute(
                    builder: (context) =>
                        PassDetails(qr_res, widget.setDataList)));
              }
            },
          ),
        ],
